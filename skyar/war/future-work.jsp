...
<div class="container-fluid">
	<div class="row-fluid">
		...
		Welcome <% if(userService.isUserLoggedIn()) out.println(request.getUserPrincipal().getName());%>
			...
			<p>
			<ol class="text-left text-info" style="font-size:16">
			<li>
			Torrent Support.<br>
			</li>
			<li>
			...
			<li>
			SKYAR for Android.<br>
			</li>
				<li>
			Live Statistics.
			</li>
			<li>
			Browser Extension to automatically capture downloads with SKYAR.<br>
			</li>
			<li>
			Automatic division of file based on users bandwidth.<br>
			</li>
			<li>
			Alert users when the downloading is done(twilio).<br>
			</li>
